...
if (bitapp) {
  bitapp.preference.getDefaultAddress().then(addresses => {
    ...
    //request an eth payment
    bitapp.wallet.requestPay('BitApp', 'eth', bitapp.eth.util.toWei('1', 'ether'), bitapp.eth.util.toWei('3', 'gwei'), '0x1e5776c667e1EB857726D96e63e524f9f3479Df2', '', 'BitApp transaction')
  })
}
